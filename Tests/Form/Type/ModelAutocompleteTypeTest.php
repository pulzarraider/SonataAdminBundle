...
class ModelAutocompleteTypeTest extends TypeTestCase
{
    public function testGetDefaultOptions()
    {
        ...
        $this->assertEquals(ModelAutocompleteType::SEARCH_TYPE_CONTAINS, $options['search_type']);
        ...
        $this->assertEquals('page', $options['req_param_name_page_number']);
        $this->assertEquals('limit', $options['req_param_name_page_limit']);
